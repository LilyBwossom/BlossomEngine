...
class Paths
{
	...
	inline static public function mods(key:String = '')
	{
		...
		if (FileSystem.exists(modsFolder))
		{
			...
			{
				var folderPath = haxe.io.Path.join([modsFolder, folderCategory]) + "/" + key;
	...
	inline static public function modCategories():Array<String>
	{
		...
		if (FileSystem.exists(modsFolder))
		{
			for (folderCategory in FileSystem.readDirectory(modsFolder))
			{
				var folderPath = haxe.io.Path.join([modsFolder, folderCategory]);
				modCategoryFolders.push(folderPath);
			}
		}
		return modCategoryFolders;
	}
