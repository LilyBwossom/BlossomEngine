...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Randomize Notes', 'randomnotes', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Opponent Notes Deal Damage', 'opponentdealsdamage', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Move Camera On Note Hit', 'movecamonnotehit', 'bool', false);
		optionsArray.push(option);
	...
	public function new()
	{
		...
		{
			var optionText:Alphabet = new Alphabet(200, (optionsArray[i].newLine ? 320 : 360), optionsArray[i].name, true);
			...
			else
			{
				...
				if (optionsArray[i].newLine)
				{
					valueText = new AttachedText(Std.string(optionsArray[i].getValue()), (optionText.width / 2) - 40, 72, true, 0.8);
					valueText.alignment = CENTERED;
				}
				else
				{
					valueText = new AttachedText(Std.string(optionsArray[i].getValue()), optionText.width + 40, 0, true, 0.8);
				}
