...
class NotesSubState extends MusicBeatSubstate
{
	...
	public static function isDefaultColors():Bool
	{
		...
		var noteRGB:Array<Array<FlxColor>> = PlayState.isPixelStage ? ClientPrefs.data.arrowRGBPixel : ClientPrefs.data.arrowRGB;
		var defaultNoteRGB:Array<Array<FlxColor>> = PlayState.isPixelStage ? ClientPrefs.defaultData.arrowRGBPixel : ClientPrefs.defaultData.arrowRGB;

		var isDefaultColors:Bool = true;
		for (i in 0...noteRGB.length)
		{
			if (noteRGB[i][0] != defaultNoteRGB[i][0] || noteRGB[i][1] != defaultNoteRGB[i][1] || noteRGB[i][2] != defaultNoteRGB[i][2])
			{
