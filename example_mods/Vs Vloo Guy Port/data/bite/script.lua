...
function onCreate()
    ...
    setProperty('clown.visible', false) --true if u want the opponent to be visible

    setProperty('owl.visible', false) --true if u want the opponent to be visible

end

function onBeatHit()
    if curBeat % 1 == 0 then
        objectPlayAnimation('clown','dance',true);
        objectPlayAnimation('owl','dance',true);
    end
